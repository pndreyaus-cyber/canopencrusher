...
/*
CO_CAN_ERRTX_PDO_LATE is an error/status flag used in CANopenNode 
to indicate that a synchronous PDO (Process Data Object) was not sent 
within the required SYNC window
*/
