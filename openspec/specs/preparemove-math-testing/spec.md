# preparemove-math-testing

## Purpose

Define expected behavior for deterministic prepareMove math computation, isolation from runtime motion, tiny-angle handling, and structured test reporting.
